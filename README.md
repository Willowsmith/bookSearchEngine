...
Melyssa your deployed application does not work, though when I cloned it I was able to get the front end to load even though your server was returning errors and did not work. You have your typedefs and resolvers set up in the server but you have no mutations or queries written in your front end. This application is currently short of what is required to pass.
